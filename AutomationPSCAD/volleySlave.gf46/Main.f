...
!---------------------------------------
      ...
      REAL    Ran1          ! Uniform Random Number Generator
...
! Control Signals
      INTEGER  IT_1, BRK2, BRK1, IT_2, IT_3
      REAL     activePower, reactivePower
      REAL     vLoad(3), iLoad(3), fType, RT_1(7)
      REAL     Vf(3), If(3), faultTime
...
!---------------------------------------
      ...
      IT_2     = STOI(ISTOI + 4)
      IT_3     = STOI(ISTOI + 5)
      faultTime = STOF(ISTOF + 23)

! Array (1:3) quantities...
      DO IT_0 = 1,3
         vLoad(IT_0) = STOF(ISTOF + 2 + IT_0)
         iLoad(IT_0) = STOF(ISTOF + 5 + IT_0)
         Vf(IT_0) = STOF(ISTOF + 16 + IT_0)
         If(IT_0) = STOF(ISTOF + 19 + IT_0)
      END DO

! Array (1:7) quantities...
      DO IT_0 = 1,7
         RT_1(IT_0) = STOF(ISTOF + 9 + IT_0)
      END DO
...
! 10:[radiolink] Wireless connection 'Fault'
      fType = TX(TXRX(ITXRX+1))
...
! 70:[random] Random Number Generator 
! Random Number Output - Uniform Distribution
      IF (FIRSTSTEP) THEN
        CALL RANDOM_MRUN(0, 0.08, 0.09, 1.0, RVD1_1)
        STORF(NSTORF) = RVD1_1
      ENDIF
      faultTime = STORF(NSTORF)
      NSTORF = NSTORF + 1
...
! Timed fault logic
      ...
      IF ( TIME .GE. (faultTime+1.5) ) IT_1 = 0
...
! 160:[breaker3] 3 Phase Breaker 'BRK2'
      IVD1_4 = NSTORI
      NSTORI = NSTORI + 3
! Three Phase Breaker
...
! 170:[pgb] Output Channel 'reactivePower'

      PGB(IPGB+10) = reactivePower

! 180:[pgb] Output Channel 'activePower'

      PGB(IPGB+11) = activePower

! 190:[tpflt] Three Phase Fault 
      CALL E3PHFLT1_EXE(SS, (IBRCH+16), (IBRCH+17), (IBRCH+18), (IBRCH+1&
     &9), (IBRCH+20), (IBRCH+21),0,IT_1,NINT(fType),0.01)
...
! 210:[breaker3] 3 Phase Breaker 'BRK1'
      IVD1_4 = NSTORI
      NSTORI = NSTORI + 3
! Three Phase Breaker
...
! 1:[source_3] Three Phase Voltage Source Model 2 '500'
! Three Phase Source: 500  Type: R
!  
      RVD1_1 = RTCF(NRTCF)
      RVD1_2 = RTCF(NRTCF+1)
...
!---------------------------------------
      ...
      STOI(ISTOI + 4) = IT_2
      STOI(ISTOI + 5) = IT_3
      STOF(ISTOF + 23) = faultTime

! Array (1:3) quantities...
      DO IT_0 = 1,3
         STOF(ISTOF + 2 + IT_0) = vLoad(IT_0)
         STOF(ISTOF + 5 + IT_0) = iLoad(IT_0)
         STOF(ISTOF + 16 + IT_0) = Vf(IT_0)
         STOF(ISTOF + 19 + IT_0) = If(IT_0)
      END DO

! Array (1:7) quantities...
      DO IT_0 = 1,7
         STOF(ISTOF + 9 + IT_0) = RT_1(IT_0)
      END DO
...
! Control Signals
      INTEGER  IT_2, IT_3
      REAL     activePower, reactivePower
      REAL     vLoad(3), iLoad(3), RT_1(7), Vf(3)
      REAL     If(3), faultTime

! Internal Variables
      INTEGER  IVD1_1, IVD10_1(10)
      REAL     RVD1_1, RVD10_1(10), RVD1_2
...
! 20:[ammeter] Current Meter 'If'
      If(1) = ( CBR((IBRCH+22), SS))
      If(2) = ( CBR((IBRCH+23), SS))
      If(3) = ( CBR((IBRCH+24), SS))

! 30:[voltmetergnd] Voltmeter (Line - Ground) 'Vf'
...
! 100:[mrun_extra] Multiple Run Additional Recording 
      CALL COMPONENT_ID(ICALL_NO,2061360230)
      IVD10_1(1)  = 3
      IVD10_1(2)  = 3
      IVD10_1(3)  = 3
      IVD10_1(4)  = 3
      ...
      IVD10_1(10) = 3
      DO IVD1_1 = 1,7
        RVD10_1(IVD1_1) = RT_1(IVD1_1)
      ENDDO
      DO IVD1_1 = 7+1,10
        RVD10_1(IVD1_1) = 0.0
      ENDDO
      CALL MRUNXTRALABELS(0,"Run#")
      CALL MRUNXTRALABELS(1,"Vfa")
      CALL MRUNXTRALABELS(2,"Vfb")
      CALL MRUNXTRALABELS(3,"Vfc")
      CALL MRUNXTRALABELS(4,"Ifa")
      CALL MRUNXTRALABELS(5,"Ifb")
      CALL MRUNXTRALABELS(6,"Ifc")
      CALL MRUNXTRALABELS(7,"Time")
      CALL MRUNXTRAFILES(7,1,IT_3,IVD10_1,RVD10_1,"mrunout")
!

! 130:[pgb] Output Channel 'vLoad'

      DO IVD1_1 = 1, 3
         PGB(IPGB+1+IVD1_1-1) = vLoad(IVD1_1)
      ENDDO

! 140:[pgb] Output Channel 'iLoad'

      DO IVD1_1 = 1, 3
         PGB(IPGB+4+IVD1_1-1) = iLoad(IVD1_1)
      ENDDO

! 150:[pgb] Output Channel 'Vf'

      DO IVD1_1 = 1, 3
         PGB(IPGB+7+IVD1_1-1) = Vf(IVD1_1)
      ENDDO
